...
public class UpdateData extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        int dueDateYear = Integer.parseInt(strings[3]);
        int dueDateMonth = Integer.parseInt(strings[4]);
        int dueDateDayOfMonth = Integer.parseInt(strings[5]);

        String serverURL = strings[0];
        String postParameters = "taskId=" + taskId + "&content=" + content
